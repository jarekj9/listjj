...
@user_passes_test(is_member)
def index(request):
    noteform = NoteForm(login=request.user)
    all_records = app.main.main(login=request.user)
    
    return render(request, 'add_note.html', {'all_records':app.main.main(login=request.user),
                                             'noteform':noteform, 
                                             'message':'',
                                             'login':request.user})
